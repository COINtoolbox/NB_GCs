...
The number of GCs increases on average X times  given each additional increase of the predictor variable (case black hole mass) by ab unit factor (1 dex in this case).
